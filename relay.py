...
relayLog = "\"Relays: {} UVB: {} Heat: {} Night: {} Bubbler: {}\"".format(GPIO.input(pin_light), GPIO.input(pin_uvb), GPIO.input(pin_heater), GPIO.input(pin_night), GPIO.input(pin_bubbler))
